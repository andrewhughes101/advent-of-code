...
public class Day3 {
    public static void main(String[] args) throws IOException {
        ...
        String co2Rate = co2Set.get(0);

        Integer oxygen = Integer.parseInt(oxygenRate,2);
        Integer co2 = Integer.parseInt(co2Rate,2);
...
public class Day3 {
    public static void main(String[] args) throws IOException {
        List<String> diagnosticList = Files.readAllLines(Paths.get("Day3Input.txt"));
        //go through each bit, if 0 do -1 from counter, if 1 do +1, total neg more 0s, total pos more 1s
        String gammaRate = "";
        Integer counter = 0;
        for(int i=0; i<diagnosticList.get(0).length(); i++) {
